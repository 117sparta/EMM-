...
<div id="documentFrame">
  <header>
    ...
    <button id="uploadBtn" @click="chooseFile"><input id="fileList" type="file" @change="fileUpload($event)"/>
      上传
    </button>
    ...
    <!--删除警告组件-->
    <dw :is-active="deleteWarningIsActive"
        @deleteConfirm="deleteConfirm"
        @deleteAbort="deleteWarningIsActive=false"></dw>
    <!--删除警告组件-->
    <!--重命名组件-->
    ...
    <!--重命名组件-->
    <div>
      <div id="fileType">全部文档</div><div id="loadingState">加载完毕(共{{fileList.length}}个)</div>
    </div>
  </header>
  <div id="listHead">
